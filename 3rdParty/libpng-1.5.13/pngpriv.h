...
#ifndef PNG_ABORT
#  if defined(_WINDOWS_) && (!defined(_DURANGO) && !defined(_M_ARM_FP) && (_MSC_VER < 1700))
...
#else
#  if defined(_WINDOWS_) && !defined(_DURANGO)  && !defined(_M_ARM_FP) && (_MSC_VER < 1700) /* Favor Windows over C runtime fns */
