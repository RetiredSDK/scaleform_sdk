...
﻿package com.scaleform.demos {
    ...
    // UI Elements:
        ...
        /** Used to deselect button group 2  */
        public var Deselect_Button:Button;
    ...
    // Protected Methods:
        override protected function configUI():void {
            ...
            // Configure a button on the stage that acts to deselect group 2
            Deselect_Button.addEventListener( ButtonEvent.CLICK, handleDeselect_ButtonClick, false, 0, true);            
            Deselect_Button.autoSize = TextFieldAutoSize.LEFT;
            Deselect_Button.label = "Deselect";
            Deselect_Button.validateNow();
        ...
        /** Calls clearSelectedButton() on group 2 to effectively deselect it */
        protected function handleDeselect_ButtonClick(e:ButtonEvent):void {
            Group2.clearSelectedButton();
        }
    }
}