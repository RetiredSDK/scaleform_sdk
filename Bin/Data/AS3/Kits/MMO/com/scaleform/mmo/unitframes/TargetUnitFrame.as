...
package com.scaleform.mmo.unitframes {
    ...
    public class TargetUnitFrame extends MovieClip {
    ...
    // UI Elements:
        ...
        protected function configUI():void { 
            DataBinding.createBinding("target.active", setActive, this);
            DataBinding.createBinding("target.name", setName, this);
            DataBinding.createBinding("target.level", setLevel, this);
        }
