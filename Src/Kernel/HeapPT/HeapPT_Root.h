...
public:
    ...
    virtual void    VisitSegments(SegVisitor* visitor, UPInt catSeg, UPInt catUnused) const;
...
public:
    ...
    virtual void    VisitSegments(Heap::SegVisitor* visitor, UPInt catSeg, UPInt catUnused) const;
