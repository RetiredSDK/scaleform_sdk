...
#ifndef INC_SF_SF_SIMD_Altivec_H
#define INC_SF_SF_SIMD_Altivec_H
#pragma once

#if defined(SF_ENABLE_SIMD) && defined(SF_CPU_ALTIVEC)
...
#endif // SF_ENABLE_SIMD && SF_CPU_Altivec

#endif // INC_SF_SF_SIMD_Altivec_H
