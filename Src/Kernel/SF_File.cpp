...
#define FILEBUFFER_ALIGN        32
#elif defined(SF_OS_WIIU)
#define FILEBUFFER_SIZE         8192
#define FILEBUFFER_ALIGN        PPC_IO_BUFFER_ALIGN
#else
#define FILEBUFFER_SIZE         (8192-8)
#define FILEBUFFER_ALIGN        1
#endif
...
{
    pBuffer     = (UByte*)SF_MEMALIGN(FILEBUFFER_SIZE, FILEBUFFER_ALIGN, Stat_Default_Mem);
    BufferMode  = NoBuffer;
    FilePos     = 0;
    Pos         = 0;
    DataSize    = 0;
